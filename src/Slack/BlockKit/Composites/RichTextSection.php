...
class RichTextSection implements ObjectContract
{
    /**
    ...
    public function toArray(): array
    {
        ...
        if (empty($this->elements)) {
            throw new LogicException('There must be at least one element in each rich text section block.');
        }

        if (count($this->elements) > 10) {
            throw new LogicException('There is a maximum of 10 elements in each rich text section block.');
        }
